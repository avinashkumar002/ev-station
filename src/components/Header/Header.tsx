                        ...
                        <div className="flex gap-10">
                            <div className="flex gap-3 items-center">
                                <div className="px-2.5 py-4" onClick={() => scrollTo("how-it-works")}>
                                    <Typography variant="para" className="cursor-pointer text-black-700 hover:text-black border-b-2 border-transparent hover:border-black inline-block transition-all duration-200">
                                        How it Works
                                    </Typography>
                                </div>
